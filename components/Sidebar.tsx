...
export function Sidebar({ onOpenSettings, isCollapsed, onToggleCollapse }: SidebarProps) {
  ...
  return (
    <div
      ...
      className={`flex flex-col h-full bg-neutral-900 border-r border-neutral-800 transition-all duration-200 ${isCollapsed ? "w-10" : "w-60"}`}
    >
      {isCollapsed ? (
        /* Collapsed: show only the toggle button */
